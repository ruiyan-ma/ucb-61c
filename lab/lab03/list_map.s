...
map:
    ...
    # THINK: why a0?
    # Answer: because the square function use a0 as the parameter
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why).
    # Answer: because you need to jump to where s1 points to, you are not jumping to a specific functon.
    ...
    # Answer: because the map function use a1 as the function pointer parameter.
    add a1, s1, x0
