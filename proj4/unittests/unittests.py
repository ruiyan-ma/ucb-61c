...
class TestAdd(TestCase):
    ...
    def test_medium_add(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(100, 200, seed=10)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(100, 200, seed=12)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_large_add(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(2000, 3000, seed=50)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(2000, 3000, seed=60)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    ...
    def test_large_abs(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(2000, 3000, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        ...
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(100, 300, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_large_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(2000, 1500, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(1500, 3000, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestPow(TestCase):
    ...
    def test_large_pow(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(300, 300, seed=0)
